//
//  WKMyItemUpdateController.swift
//  AllMarket
//
//  Created by 김민주 on 2017. 9. 29..
...
class WKMyItemUpdateController: UIViewController, WKUIDelegate, WKNavigationDelegate, WKScriptMessageHandler, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UIScrollViewDelegate {
    ...
    override func loadView() {
        ...
        navigationTitle(self, "itemModify".localized);
        ...
        controller.add(self, name: "startProductModified")
...
//        self.wkWebView.scrollView.isScrollEnabled = false
    ...
    func settingWebView() {
        ...
        let javascriptPOSTRedirect: String = "" +
            ...
            "form.method = 'POST';" +
            "form.action = '\(domain + itemUpdateURL+"/\(myItemIdx)")';" +
            "" +
    ...
    func userContentController(_ userContentController: WKUserContentController, didReceive message: WKScriptMessage) {
        ...
        if message.name == "startProductModified"{
...
//        view.addSubview(activityIndicator)
    ...
    func DoneBtn(_ sender: UIBarButtonItem) {
        wkWebView.evaluateJavaScript("writing2()", completionHandler: nil)
//        self.navigationController?.popViewController(animated: true)
    }
